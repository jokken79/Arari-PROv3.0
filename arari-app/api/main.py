...
@app.get("/api/additional-costs/{cost_id}")
...
@app.put("/api/additional-costs/{cost_id}")
...
@app.delete("/api/additional-costs/{cost_id}")
...
@app.get("/api/additional-costs/company/{company_name}/total")
...
@app.post("/api/additional-costs/copy")
